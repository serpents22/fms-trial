          ...
          <div class="modal-inner" v-show="isOpen" ref="target">
            <div class="modal-content">
              ...
              <div class="button-wrapper">
                <BaseButton type="button" class="filled__red" :label="delLabel" :loading="deleteVehicleIsLoading" @click="onSubmit(props.deviceInfo.id)" />
...
import { onClickOutside } from '@vueuse/core'
  ...
  const { status, deleteVehicleIsLoading } = storeToRefs(useVehiclesStore())
